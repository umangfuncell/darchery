...
public class Shatter : MonoBehaviour
{
    ...
    void OnDartDetect(Collider collision)
    {
        ...
        if (collision.gameObject.CompareTag("Dart"))
        {
            ...
            {
                StartCoroutine(shattering(collision.gameObject));
    ...
    IEnumerator shattering(GameObject dart)
    {
        yield return new WaitForSeconds(0.3f);
        TriggerShatter(dart);

    }
    private void TriggerShatter(GameObject dart)
    {
        ...
        foreach (GameObject obj in objectsToShatter)
        {
            if (obj != null)
            {
                ...
                rb.AddExplosionForce(
                    ...
                    rb.transform.position + UnityEngine.Random.insideUnitSphere * 0.2f, // Randomize explosion center just a bit for variety
